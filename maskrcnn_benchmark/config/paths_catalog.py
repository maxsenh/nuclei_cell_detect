    ...
    DATASETS = {
        ...
        "coco_transfer_train_new": {
         ...
         "coco_transfer_test_new": {
            "img_dir": "/data/proj/smFISH/Students/Max_Senftleben/files/data/20190508_new/test/",
            "ann_file": "/data/proj/smFISH/Students/Max_Senftleben/files/data/20190508_new/anno/test.json"
        },
